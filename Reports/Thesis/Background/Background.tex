...
When the word2vec algorithm is trained using the Skip-gram model, one will have a lookup table. This table contains the mapping of words to their vector representation. This can be seen as a 2-layer neural network with as goal function the function described in the previous section. \\
