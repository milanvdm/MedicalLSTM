...
\item In the field of classification neural networks are used to achieve state of the art results.
\item For regression, Support Vector Machines can be used. 
\item One of the most popular methods for clustering is K-means.
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{dwAlgo.png}
