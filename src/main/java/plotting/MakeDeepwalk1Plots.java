...
public class MakeDeepwalk1Plots {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		List<Deepwalk1> listToPlot = new ArrayList<Deepwalk1>();
		Iterator<List<Deepwalk1>> iter = combos.values().iterator();
		int name = 0;
		...
		while(iter.hasNext()){
			...
			File BarChart = new File( "Plots/wl/Deepwalk1/Deepwalk1 - " + name + ".jpeg" ); 
